...
void nvboard_bind_all_pins(Vtop* top) {
	...
	nvboard_bind_pin( &top->seg4, BIND_RATE_SCR, BIND_DIR_OUT, 7, SEG4G, SEG4F, SEG4E, SEG4D, SEG4C, SEG4B, SEG4A);
	nvboard_bind_pin( &top->seg5, BIND_RATE_SCR, BIND_DIR_OUT, 7, SEG5G, SEG5F, SEG5E, SEG5D, SEG5C, SEG5B, SEG5A);
